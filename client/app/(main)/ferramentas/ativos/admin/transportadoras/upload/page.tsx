...
import { previewCarrierCsv, ingestCarrierCsv } from '@/services/sgaAgentcore';
  ...
  const ingestMutation = useMutation({
    ...
    onSuccess: (data) => {
      if (data.success) {
        ...
        setTimeout(() => {
          router.push('/ferramentas/ativos/admin/transportadoras');
        }, 2000);
      }
    },
  });
        ...
        <div>
          <div className="flex items-center gap-2 mb-2">
            <Button variant="ghost" size="sm" asChild>
              <Link href="/ferramentas/ativos/admin/transportadoras">
          ...
          <p className="text-sm text-text-muted mt-1">
            Upload de CSV com deteccao automatica de schema
          </p>
        </div>
      </div>
        ...
        <GlassCard>
          <GlassCardHeader>
            <div className="flex items-center justify-between">
              <GlassCardTitle>2. Schema Detectado</GlassCardTitle>
              {preview && (
          ...
          <GlassCardContent>
            {!preview ? (
              <div className="text-center py-12">
                ...
                <p className="text-sm text-text-muted">
                  Faca upload de um CSV e clique em "Detectar Schema"
                  <br />
