...
import { listCarriers } from '@/services/sgaAgentcore';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-2">
            <Button variant="ghost" size="sm" asChild>
              <Link href="/ferramentas/ativos/dashboard">
        ...
        <div className="flex gap-2">
          ...
          <Button size="sm" asChild>
            <Link href="/ferramentas/ativos/admin/transportadoras/upload">
                      ...
                      <td className="py-3 px-4 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <Button
                            ...
                            asChild
                          >
                            <Link href={`/ferramentas/ativos/admin/transportadoras/upload?carrier=${carrier.carrier_id}`}>
